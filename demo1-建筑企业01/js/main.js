$(function(){
	...
	$(".banner").each(function () {
	    if ($(this).find(".item").length > 2) {
	        var owl = $(this).owlCarousel({ items: 1, dots: false, nav: true, navText: ["<img src='img/cur1.png' />", "<img src='img/cur2.png' />"], loop: true, autoplay: true });
	...
	$(".page_owl").owlCarousel({
	    ...
	    dots: false, nav: true, navText: ["<img src='img/cur3.png' />", "<img src='img/cur4.png' />"], margin: 10
	})
	...
	$(".team_list ul").owlCarousel({
	    ...
	    dots: false, nav: true, navText: ["<img src='img/cur3.png' />", "<img src='img/cur4.png' />"], margin: 20
	})
