...
class AdminController extends Controller {
     ...
     * @author 朱亚杰  <zhuyajie@topthink.net>
     */
    protected function forbid ( $model , $where = array() , $msg = array( 'success'=>'文档禁用成功！', 'error'=>'文档禁用失败！')){
        $data    =  array('status' => 0);
     ...
     * 推荐条目
     */
    protected function hot (  $model , $where = array() , $msg = array( 'success'=>'文档推荐成功！', 'error'=>'文档推荐失败！')){
        $data    =  array('status' => 4);
        $this->editRow(   $model , $data, $where, $msg);
    }
     ...
     * @author 朱亚杰  <zhuyajie@topthink.net>
     */
    protected function resume (  $model , $where = array() , $msg = array( 'success'=>'文档恢复成功！', 'error'=>'文档恢复失败！')){
        $data    =  array('status' => 1);
        $this->editRow(   $model , $data, $where, $msg);
    }
     ...
     */
    protected function restore (  $model , $where = array() , $msg = array( 'success'=>'文档还原成功！', 'error'=>'文档还原失败！')){
        $data    = array('status' => 1);
    ...
    public function setStatus($Model=CONTROLLER_NAME){
        ...
        switch ($status){
            ...
            case 1  :
                ...
                break;
			case 4  :
				$this->hot($Model,$map,array('success'=>'推荐成功','error'=>'推荐失败'));
            default :
                $this->error('参数错误');
                break;
        }
    ...
    protected function lists ($model,$where=array(),$order='',$field=true){
        ...
        $page = new \Think\Pageadmin($total, $listRows, $REQUEST);
        if($total>$listRows){
