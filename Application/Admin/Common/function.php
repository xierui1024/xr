    ...
    if(!empty($grid['href'])){
        ...
        foreach($links as $link){
            ...
            if(preg_match('/^\[([a-z_]+)\]$/',$href,$matches)){
				...
				if('预览'==$show)
				{
					$val[]  = "<a href=/home/Article/detail?id=$data[id]>预览</a>";
				}
				else
				{
...
function get_attribute_type($type=''){
    ...
    static $_type = array(
        ...
        'file'      =>  array('上传附件','char(100) UNSIGNED NOT NULL'),
        'duotu'      =>  array('多图上传','char(100) UNSIGNED NOT NULL'),
        'img_caijian'      =>  array('图片裁剪','int(10) UNSIGNED NOT NULL'),
