		...
		<div class="tab-content">
			<form action="<?php echo U();?>" method="post" class="form-horizontal">
				...
				<div id="tab1" class="tab-pane in tab1">
					...
					<div class="form-item">
						<label class="item-label">
							英文名称<span class="check-tips"></span>
						</label>
						<div class="controls">
							<input type="text" name="e_name" class="text input-large" value="<?php echo ((isset($info["e_name"]) && ($info["e_name"] !== ""))?($info["e_name"]):''); ?>">
						</div>
					</div>
					<div class="form-item">
						<label class="item-label">
					...
					<div class="form-item">
						<label class="item-label">
							网站外链<span class="check-tips">（如：http://www.moodao.com）</span>
						</label>
						<div class="controls">
					...
					<div class="form-item">
						<label class="item-label">
							banner标题<span class="check-tips"></span>
						</label>
						<div class="controls">
							<input type="text" name="banner_title" class="text input-large" value="<?php echo ((isset($info["banner_title"]) && ($info["banner_title"] !== ""))?($info["banner_title"]):''); ?>">
						</div>
					</div>
					
					<div class="form-item">
						<label class="item-label">
							banner简介<span class="check-tips"></span>
						</label>
						<label class="textarea input-large">
								<textarea name="banner_jianjie"><?php echo ((isset($info["banner_jianjie"]) && ($info["banner_jianjie"] !== ""))?($info["banner_jianjie"]):''); ?></textarea>
							</label>
					</div>
					...
					<div class="controls">
						...
						<?php if(!empty($info['icon'])): ?><div class="upload-pre-item"><img src="<?php echo (get_cover($info["icon"],'path')); ?>"/></div>
