            ...
            <div class="ui-mainlrct wow fadeInUp">
                <div class="l">
                    ...
                    <div class="ui-leftnavi">
                        <ul>
                            <?php if(is_array($aboutus)): $i = 0; $__LIST__ = $aboutus;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li><p><a href="<?php echo U('Index/aboutus?id='.$v['id']);?>"><?php echo ($v['about_aname']); ?>ff</a></p></li>
