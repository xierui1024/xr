<?php if (!defined('THINK_PATH')) exit(); $top=M('document_solution_tent')->where('top=1')->order('id desc')->limit(10)->select(); $banner=M('document_newsimg as a') ->join('modao_picture as b on a.img=b.id') ->order('a.id desc') ->field('a.*,b.path') ->limit(1) ->find(); ?>
<!DOCTYPE html>
<html lang="zh">
	<head>
		<meta charset="utf-8">
